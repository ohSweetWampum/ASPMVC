    ...
    public partial class ProductAndCategoryTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_myCategoryTable", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_myProductTable", x => x.Id);
                    table.ForeignKey(
                        name: "FK_myProductTable_myCategoryTable_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "myCategoryTable",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_myProductTable_CategoryId",
                table: "myProductTable",
                column: "CategoryId");
        }
